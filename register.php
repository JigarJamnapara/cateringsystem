         ...
         <div class="container">
            <div class="contact_main">
               ...
               <div class="form-group">
                  ...
                  <div class="form-group">
                     <input type="password" class="email-bt" placeholder="Password " name="txt_password">
                  </div>

                  <div class="form-group">
                     <input type="password" class="email-bt" placeholder="Confirm Password" name="txt_cpassword">
                  </div>
